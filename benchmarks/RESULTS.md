...
| Metric | Value |
| --- | --- |
| Render throughput | 7.043 ms/card ≈ 142 cards/s (200 cards, 10 iterations, median 140.9 ms/iter) |
| PNG output size (640×360 card) | 28,908 bytes |
| JPEG output size (640×360 card, q90) | 13,120 bytes |
| Cold start (min / median, 5 runs) | 382.1 ms / 386.5 ms |
| Total measured | 1400.2 ms for 200 cards |
...
> Auto-generated by `bun benchmarks/bench.mjs --update` on 2026-09-07T04:08:05.498Z. Edit methodology/notes manually, but Results/Machine are overwritten on next `--update`.
